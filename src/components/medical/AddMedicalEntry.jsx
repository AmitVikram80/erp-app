...
const AddMedicalEntry = () => {
    ...
    const fetchEmployeeDetails = async () => {
        ...
        try {
            ...
            const { data: dependantsData } = await axiosInstance.get(`/dependant/employee/${employeeId}`);
        ...
        <form onSubmit={handleSubmit} className="container mt-4">
            ...
            <div className="mb-3">
                ...
                <div className="input-group">
                    ...
                    />
                    <button type="button" className="btn btn-primary" onClick={fetchEmployeeDetails} disabled={loading}>
            ...
            <button type="button" className="btn btn-secondary ms-2" onClick={() => navigate(`/`)} disabled={loading}>
                Cancel
            </button>
        </form>
    );
