...
const RelievingPage = () => {
  ...
  const navigateHome = () => navigate("/admin-dashboard/relieving-list");
  ...
  const modifyRelieving = (relievingId, relieving) => {
    return axiosInstance.put(
      `/admin/modRelievingReport/${relievingId}`,
      relieving
    );
  };
  ...
  const saveRelieving = (e) => {
    ...
    if (id) {
      modifyRelieving(id, relieving)
        .then(() => {
          navigate("/admin-dashboard/relieving-list");
          resetForm();
        })
